...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', description?: string | null, videoId: string, title: string, teacher?: { __typename?: 'Teacher', bio: string, name: string, avatarURL: string } | null } | null };
...
export function useGetLessonsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetLessonsQuery, GetLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetLessonsQuery, GetLessonsQueryVariables>(GetLessonsDocument, options);
        }
...
export type GetLessonsSuspenseQueryHookResult = ReturnType<typeof useGetLessonsSuspenseQuery>;
